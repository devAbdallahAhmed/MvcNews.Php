...
<html lang="en">
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?= CSS_PATH; ?>front/css/bootstrap.css" rel="stylesheet">

    <!-- FontAwesome Icons core CSS -->
    <link href="<?= CSS_PATH; ?>front/css/font-awesome.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<?= CSS_PATH; ?>front/css/style.css" rel="stylesheet">

    <!-- Responsive styles for this template -->
    <link href="<?= CSS_PATH; ?>front/css/responsive.css" rel="stylesheet">

    <!-- Colors for this template -->
    <link href="<?= CSS_PATH; ?>front/css/colors.css" rel="stylesheet">
                ...
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link color-pink-hover" href="blog-category-01.html"><?= $c['name']; ?></a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
